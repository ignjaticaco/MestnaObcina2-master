		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 animate-box">
					<h1><span class="colored">Kontaktirajte</span> Nas</h1>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>Titov Trg 1, 3320 Velenje</li>
						<li><i class="icon-phone"></i> 03 8961 600</li>
						<li><i class="icon-envelope"></i><a href="#">www.MestnaObcinaV/contact.php</a></li>
						<li><i class="icon-globe"></i><a href="#">www.MestnaObcinaV.com</a></li>
					</ul>
				</div>
